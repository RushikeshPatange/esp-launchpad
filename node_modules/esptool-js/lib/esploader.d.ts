...
export declare class ESPLoader {
    ...
    constructor(transport: Transport, baudrate: number, terminal: IEspLoaderTerminal, rom_baudrate?: number, debugLogging?: boolean);
    ...
    toHex(buffer: number | Uint8Array): any;
    flash_md5sum(addr: number, size: number): Promise<any>;
